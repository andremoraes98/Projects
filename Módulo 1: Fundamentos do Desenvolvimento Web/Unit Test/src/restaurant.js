  ...
  const menu = {
    ...
    pay: () => {
      ...
      for (let index = 0; index < menu.consumption.length; index += 1) {
        if (Object.keys(object.food).includes(menu.consumption[index])) {
          total += Object.values(object.food)[Object.keys(object.food).indexOf(menu.consumption[index])];
        } else {
          total += Object.values(object.drink)[Object.keys(object.drink).indexOf(menu.consumption[index])];
        }
      }
      return total * 1.1;
    },
